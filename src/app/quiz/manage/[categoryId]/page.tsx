        ...
        <CardContent>
          {isLoading ? (
            ...
            <>
              ...
              {questions.length > 0 ? (
                <div className="flex flex-col min-h-0"> {/* Flex container for questions section */}
                  ...
                  <ScrollArea className="flex-grow min-h-0 max-h-[50vh] pr-2 sm:pr-4"> {/* ScrollArea grows and is capped */}
